...
app.use('/E-Consultation-Listing-Page_files', express.static(path.join(__dirname, 'E-Consultation Listing Page_files')));
...
app.post('/api/comments', (req, res) => {
    const newComment = { text: req.body.comment, timestamp: new Date().toISOString() };
